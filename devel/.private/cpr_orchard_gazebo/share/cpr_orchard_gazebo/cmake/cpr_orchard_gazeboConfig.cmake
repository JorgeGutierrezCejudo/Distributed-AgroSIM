...
if("TRUE" STREQUAL "TRUE")
  set(cpr_orchard_gazebo_SOURCE_PREFIX /home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/src/cpr_gazebo/cpr_orchard_gazebo)
  set(cpr_orchard_gazebo_DEVEL_PREFIX /home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/devel/.private/cpr_orchard_gazebo)
  ...
  set(cpr_orchard_gazebo_INSTALL_PREFIX /home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cpr_orchard_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/src/cpr_gazebo/cpr_orchard_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/devel/.private/cpr_orchard_gazebo/lib;/home/jorgeurjc/WorkSpace/ROS1/Distributed-AgroSIM/devel/lib;/opt/ros/noetic/lib)
