...
(cl:defmethod cl:initialize-instance :after ((m <PosRot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PosRot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrolling_sim-msg:<PosRot> is deprecated: use patrolling_sim-msg:PosRot instead.")))
...
(cl:defmethod rot_x-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patrolling_sim-msg:rot_x-val is deprecated.  Use patrolling_sim-msg:rot_x instead.")
  (rot_x m))

(cl:ensure-generic-function 'rot_y-val :lambda-list '(m))
(cl:defmethod rot_y-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patrolling_sim-msg:rot_y-val is deprecated.  Use patrolling_sim-msg:rot_y instead.")
  (rot_y m))

(cl:ensure-generic-function 'rot_z-val :lambda-list '(m))
(cl:defmethod rot_z-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patrolling_sim-msg:rot_z-val is deprecated.  Use patrolling_sim-msg:rot_z instead.")
  (rot_z m))

(cl:ensure-generic-function 'rot_w-val :lambda-list '(m))
(cl:defmethod rot_w-val ((m <PosRot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patrolling_sim-msg:rot_w-val is deprecated.  Use patrolling_sim-msg:rot_w instead.")
  (rot_w m))
